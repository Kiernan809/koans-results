...
class AboutRegularExpressions < Neo::Koan
  ...
  # Why?
  def greedy_to_end
    assert_equal "e rest, Okay?", "The rest, Okay?"[/e.*/]
  end
  ...
  def test_the_left_most_match_wins
    ...
    # assert_equal "az", "abbccc az"[/az*/g]
  end
  ...
  def differentiate_char_alternation
    # assert_equal nil, "abcxdef"[/a*c/]
  end
