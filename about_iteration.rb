...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    starting_sum = 0
    result3 = [2,3,4].inject(starting_sum) do |running_sum, array_element|
      # 0 + 2, 2 + 3, 5 + 4
      # starting_sum + array[0] = running_sum
      # running_sum + array[1] = running_sum
      # running_sum + array[2] = running_sum
      # return running_sum

      running_sum + array_element
    end
    assert_equal 9, result
  end
